 ...
 * [com.citypass.webhooks.service.SchemaRegistryService] para comunicarse con el Schema Registry
 * y por [com.citypass.webhooks.service.WebhookDeliveryService] para entregar eventos via webhook.
 */
@Configuration
class RestClientConfig {
    ...
    fun webhookRestClient(
        @Value("\${dispatcher.webhook-connect-timeout-ms}") connectTimeoutMs: Long,
        @Value("\${dispatcher.webhook-read-timeout-ms}") readTimeoutMs: Long
