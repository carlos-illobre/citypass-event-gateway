...
import com.citypass.webhooks.service.CallbackUrlValidator
import com.citypass.webhooks.service.SubscriptionService
import com.citypass.webhooks.service.WebhookDeliveryService
 ...
 * el dispatcher lo deserializa y lo entrega a todas las URLs suscritas.
 *
...
Cada vez que llegue un evento al tópico indicado, el dispatcher hará un POST a la callbackUrl con el evento en el body.
Si el POST falla, reintenta hasta 3 veces con 2 segundos entre intentos.

La callbackUrl tiene que ser una URL pública: el dispatcher corre en otra máquina, así que `localhost`
