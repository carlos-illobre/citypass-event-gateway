package com.citypass.webhooks.integration

import com.citypass.webhooks.service.AvroService
...
class EntregaDurableTest {
    ...
    private companion object {
        ...
        const val GRUPO = "webhook-dispatcher-$TOPICO"
    ...
    fun `el offset avanza evento por evento, sólo despues de entregar cada uno`() {
        ...
        // y todavía no. Si el dispatcher muriera acá, se releería el segundo y no el primero.
        //
